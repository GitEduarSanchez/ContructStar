...
Public Class inf_mes_machetazo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaVallesas.SAS.inf_mes_machetazo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinf_mes_machetazo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As inf_mes_machetazo = New inf_mes_machetazo()
        rpt.Site = Me.Site
        Return rpt
    End Function
