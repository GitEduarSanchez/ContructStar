...
Public Class inf_mes_petrovial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaVallesas.SAS.inf_mes_petrovial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinf_mes_petrovial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As inf_mes_petrovial = New inf_mes_petrovial()
        rpt.Site = Me.Site
        Return rpt
    End Function
