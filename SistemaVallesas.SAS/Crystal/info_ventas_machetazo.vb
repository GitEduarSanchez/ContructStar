...
Public Class info_ventas_machetazo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "info_ventas_machetazo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaVallesas.SAS.info_ventas_machetazo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinfo_ventas_machetazo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As info_ventas_machetazo = New info_ventas_machetazo()
        rpt.Site = Me.Site
        Return rpt
    End Function
