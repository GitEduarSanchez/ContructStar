...
Public Class servidor_petrovial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaVallesas.SAS.servidor_petrovial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedservidor_petrovial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As servidor_petrovial = New servidor_petrovial()
        rpt.Site = Me.Site
        Return rpt
    End Function
