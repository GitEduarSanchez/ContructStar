...
Public Class MDIParent1
    ...
    Private Sub InformePorDestinoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles InformePorDestinoToolStripMenuItem.Click
        cerrar()
       
    End Sub

    Private Sub VehiculosToolStripMenuItem_Click(sender As Object, e As EventArgs)
        frm_agrega_vehiculo.ShowDialog()
    End Sub

    Private Sub ConductorToolStripMenuItem_Click(sender As Object, e As EventArgs)
        frm_conductor.ShowDialog()
    End Sub

    Private Sub PrintPreviewToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PrintPreviewToolStripMenuItem.Click
        frm_titulo.ShowDialog()
    End Sub

    Private Sub TipoVehiculoToolStripMenuItem_Click(sender As Object, e As EventArgs)
        frm_tipovehiculo.ShowDialog()
    End Sub

    Private Sub OrigenToolStripMenuItem_Click(sender As Object, e As EventArgs)
        frm_origen.ShowDialog()
    End Sub

    Private Sub DestinoToolStripMenuItem_Click(sender As Object, e As EventArgs)
        frm_destino.ShowDialog()
    End Sub

    Private Sub AnprToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AnprToolStripMenuItem.Click
    ...
    Private Sub TituloToolStripMenuItem_Click(sender As Object, e As EventArgs)
        frm_titulo.ShowDialog()
    End Sub

    Private Sub ConsultasToolStripMenuItem_Click(sender As Object, e As EventArgs)
        cerrar()
        frm_consulta.MdiParent = Me
        frm_consulta.Show()
    End Sub
    ...
    Private Sub ListadoDeLicenciasToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ListadoDeLicenciasToolStripMenuItem.Click
        cerrar()
