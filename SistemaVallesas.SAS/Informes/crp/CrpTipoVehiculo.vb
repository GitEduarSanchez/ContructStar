...
Public Class CrpTipoVehiculo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaVallesas.SAS.CrpTipoVehiculo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpTipoVehiculo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpTipoVehiculo = New CrpTipoVehiculo()
        rpt.Site = Me.Site
        Return rpt
    End Function
