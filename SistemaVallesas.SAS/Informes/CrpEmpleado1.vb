...
Public Class CrpEmpleado1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaVallesas.SAS.CrpEmpleado1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpEmpleado1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpEmpleado1 = New CrpEmpleado1()
        rpt.Site = Me.Site
        Return rpt
    End Function
